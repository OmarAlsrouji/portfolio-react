...
const Navbar = () => {
  return (
    <nav className="mb-20 flex items-center justify-between py-6 flex-wrap"> 
        <div className="flex flex-shrink-0 items-center">
            <img className="mx-2" width={150} src={logo} alt="logo" />
        </div>
        <motion.div whileInView={{opacity:1, x:0}} initial={{opacity:0,x:100}} transition={{duration:0.5}} className="m-3 items-center justify-center gap-4 flex">
